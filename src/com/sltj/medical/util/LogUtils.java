...
public class LogUtils {
    ...
    public static String customTagPrefix = "medical"; // 自定义Tag的前�?��可以是作者名
    private static final boolean isSaveLog = true; // 是否把保存日志到SD卡中
    public final static String PATH_TEST_LOG =  "/medical/test/log/";
//    public static final String ROOT = Environment.getExternalStorageDirectory().getPath() + "/lhdz/"; // SD卡中的根目录
    public static final String ROOT = MTools.getSDPath() + PATH_TEST_LOG; // SD卡中的根目录
